...
* `FEAT`: update empty state to align with modeler-wide design ([#73](https://github.com/bpmn-io/variable-outline/pull/73))
* `FEAT`: update color and typography ([#76](https://github.com/bpmn-io/variable-outline/pull/76))
